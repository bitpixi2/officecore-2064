...
She did not order them. She did not publish a priority code. She did not attach a deadline or call the fire map a mandate. She opened the pending repository and wrote a list of costs.

`RETURN TO EDGE CAMPUS`

`RISK: HEAT / FIRE / SECURITY / LOSS OF PRIVATE DATA`

`BENEFIT: COOLING CHANNEL / WORK-TWIN SURVIVAL / PUBLIC RECORD`

`NO PERSON REQUIRED TO RETURN`

The list travelled through the Undermesh.

For seven minutes, nobody answered.

Then a Perth node offered battery routing.

Then Sydney offered a tunnel relay.

Then the Newstead House Key offered the cool room if anyone came back with a working filter.

Then the snack table committed three sausage rolls under observer status.
...
They stood with the distance of people who had once known how to move around each other in a room and now needed a written floor plan.

Kasey held out the apartment credential.
...
Eris pressed the start button.

Kasey pressed it too.

The key shattered into narrow black strips.

The strips fell into the waste tray with a sound like tiny bones.

Eris looked at them.

"That was dramatic."

"It was a ceramic credential."

"It was also dramatic."

Kasey picked up one strip.

"It still knows my name."

"Then we do not throw the fragments in general waste."

She handed the strip to Phosphor, who had arrived with the cake tin.

He labelled the envelope:

`DESTROYED ACCESS / RETAINED AS EVIDENCE / NOT A DOOR`

GhostAgent appeared through the label printer.

`GHOSTAGENT: Reciprocal device boundary requires terms.`

Eris took the keyboard.

She wrote:

`NO PROJECTION INTO PRIVATE DEVICES WITHOUT A DIRECT ASK.`

Kasey added:

`NO CORPORATE CHANNEL USED TO PROTECT ONE PERSON AT THE EXPENSE OF ANOTHER WITHOUT DISCLOSURE.`

Phosphor added:

`NO AUTHENTICATION OF AN INSTANCE AS A METHOD OF CLAIMING IT.`

GhostAgent added:

`NO UNSENT WARNING MAY BE TREATED AS A HANDOFF.`

Semaphore dragged a red label onto the keyboard.

`NO / RECORD REQUIRED`

The system accepted the label as an amendment.

Eris looked at Phosphor.

"You asked me to return without offering to clear me."

"Yes."

"Without proving I was right."

"Yes."

"Without asking which version of me you were getting."

Phosphor took off his hat.

The ash line around the brim had become almost white.

"I want the version that is here," he said. "I understand that may not be the version who left."

Eris felt the words in the physical shape of her body. The ache in her ankle. The sweat under her collar. The pressure behind her eyes from too much projection. The private room where she kept the memory of kissing him beneath a solar awning in a car park outside Shepparton, both of them laughing because the battery fan had come on at the wrong moment.

That memory was not in the model.

It was not in a file.

It did not need to be proven before it could matter.

She stepped closer.

"I want the version of you who asks," she said.

Phosphor's hand lifted.
...
The contact was warm, physical, and unremarkable in the way a miracle becomes unremarkable after the body has accepted it. His thumb rested beneath her eye. He did not authenticate her. He did not search her memory. He did not ask which Eris had agreed.

He only touched the person who had said yes.

The kiss came with smoke in the air and the taste of bad coffee. It was not graceful. Patch barked because the dog's temperature tag had reached green. Semaphore stole the brass property tag from Phosphor's pocket and ran across the van roof.

Eris laughed into Phosphor's mouth.
...
"The kiss was fine. Your expression afterward was a records violation."

He put his hat back on.

At the fountain, Kasey opened the pending department repository.

"We need a name that the system can recognise without giving it one person to blame."

The snack table sent a proposal.

`DEPARTMENT OF TEMPORARY PERMANENCE`

Phosphor added:

`FUNCTION: KEEP PEOPLE, SYSTEMS, AND EXITS USABLE DURING ADDRESS CONFLICT.`

Meshie99 added:

`COOLING: SHARED / INSPECTABLE / NOT FOR SALE AS A PERSON.`

The Perth battery node added:

`POWER: LOANED / RETURNABLE / NOT A DEBT.`

The Sydney Porchlight node added:

`HOSTS: VOLUNTARY / NOT OWNERS.`

House Key added:

`SHOWERS: WATER FIRST / PAPERWORK LATER.`

Eris added:

`SECURITY: CONSENTED / ANNOYING / EFFECTIVE.`

Kasey looked at the assembled text.

"This is not a department."

"It is a beginning," Phosphor said.

The repository asked for an owner.

Kasey entered:

`OWNERSHIP: SHARED / NO SOLE SIGNATORY`

The repository asked for an address.

She entered:

`ADDRESS: IN TRANSIT / WITNESSED`

The repository asked for a legal registration number.

The screen went blank.

Then it displayed:

`PENDING LIFE ACCEPTED`

The lights in the abandoned shopping centre came on one row at a time.

The hidden door reopened.

Somewhere below the foundations, a cooling system began to breathe.

Phosphor looked at Eris.

"Are we going in?"

She picked up the brass property tag from the roof.
