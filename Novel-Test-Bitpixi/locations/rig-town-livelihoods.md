# Rig-Town Livelihoods

## Status

Bitpixi-led fiction guidance for the lived economics of Officecore 2064. It makes the campervans homes, workplaces, and maintenance burdens, rather than treating them as stylish transport.

## How A Rig Pays Its Way

The crew calls their work `netrunning` when they are being dramatic and `field support` when an invoice is involved. It is not a single outlaw profession. It is a mix of legitimate, precarious, civic, and cooperative work performed through a mobile network kit:

- restoring local mesh and Skystitch links after smoke, storms, or blackouts
- repairing, migrating, or recovering records for households, makers, clinics, small businesses, and councils
- maintaining sensors, cooling alerts, accessible booking systems, event feeds, and remote help desks
- translating data-centre or vendor language into a decision a community can actually make
- providing short on-call shifts where a fixed office cannot reach
- teaching people to maintain their own devices and relays rather than creating permanent dependence

The important dramatic question is not "can they break into a system?" It is "who needs this system to work, who is paying, who is being excluded, and what does the crew risk by taking the job?"

### Payment Grammar

The crew uses several forms of value at once:

- cash or account transfer for contracted work
- cooperative ledger credits for agreed shared services
- a replacement pump, tyre, cable, data allowance, tool access, or repair bench
- a legal overnight berth, shore power, storage locker, water refill, or access appointment
- a future favour with a named scope and expiry
...
The counter is open. One person is on calls, another is repairing a cable, and the only clear floor is a strip between the fridge and the side hatch. Shoes go into a crate. The table is paperwork. The passenger seat is a guest chair until it becomes a ladder. The solar controller clicks behind a vent. Somebody's towel is always drying in the wrong place.

### Night Configuration

Before sleep, the paid work must physically disappear. Files lock into a rail or slide under the bench. The monitor swings flat. The counter drops over the passenger footwell. A couch becomes a narrow bed; a drawer pulls into a bunk; a curtain makes a room out of an arm's length. A person who has spent the day directing an incident may still have to shift batteries, boil water, check the roof seal, and negotiate who gets the cooler side of the mattress.

### Maintenance Beats

Use small faults to make the world tactile and to give the crew reasons to depend on one another:
...
Kasey's rule is that trash is proof of life. It shows that someone was somewhere, had a particular need, and made it through part of the day. It can help a search, a resupply plan, or a local history. It can also become surveillance. The ethical tension is that evidence must be handled as consentfully as any other personal record.
...
Use `regional food hub`, `community pantry`, `food-rescue kitchen`, `social cafe`, or a local fictional name such as `Common Table` for the story's food network. Crews may volunteer to sort produce, drive a delivery, repair a fridge, cook, or set up chairs. That contribution matters, but it is never the price of a meal, a hamper, or emergency support.

Foodbank Victoria's current model works through charity partners, community food centres, and volunteers. In the novel, that informs a dignity-first culture of choice and local distribution, rather than a "work for food" arrangement. Someone who is exhausted, broke, newly arrived, disabled, caring for children, or simply hungry gets to eat without performing gratitude or labour.

## Scene Prompts

- Phosphor converts Chapel Seven from a records office into a sleeping space by locking the printer tray, sliding the tea service into its crash cradle, and releasing a bunk from behind the filing cabinets.
- Kasey loses a paid overnight civic-data repair shift because The Cubicle's water pump leaks into the cable drawer. A neighbourhood house offers a booked shower and refill, but not a repair bay; the crew must decide where to spend its last dry towels and battery power.
- Eris takes a well-paid vendor audit, then redirects part of the fee to pay a pantry's failed cool-room bill. Kasey calls this financially reckless. Eris calls it a rebate for living in society.
- A community food hub needs an accessible ordering form repaired before a heatwave distribution. The work is paid. The volunteers and visitors still eat together afterward because the food system is not an employment test.
